import { startOfDay, endOfDay, addDays, subDays, max, min, setHours, setMinutes, setSeconds, setMilliseconds } from 'date-fns';
/**
 * Calculates the overlap in seconds between a time interval [start, end]
 * and the daily night window (22:00 - 06:00).
 */
export function calculateNightOverlap(start, end) {
    if (start >= end)
        return 0;
